    ...
    <form onSubmit={handleSubmit}>
      <div className="d-flex justify-content-center flex-column flex-md-row flex-wrap p-3 ">
        <div className="m-2 form-element d-flex justify-content-center  bg-light">
          <label className="  p-2 mt-1 " htmlFor="first_name">
            <h3>First Name</h3>
            <input
              name="first_name"
              type="text"
        ...
        <div className="m-2  form-element d-flex justify-content-center bg-light">
          <label className=" p-2 mt-1 " htmlFor="last_name">
            <h3>Last Name</h3>
            <input
              name="last_name"
              type="text"
        ...
        <div className="m-2 form-element d-flex justify-content-center bg-light">
          <label className=" p-2 mt-1 " htmlFor="reservation_date">
        ...
        <div className="m-2  form-element d-flex justify-content-center bg-light">
          <label className=" p-2 mt-1 " htmlFor="reservation_time">
        ...
        <div className="m-2  form-element d-flex justify-content-center bg-light">
          <label className=" p-2 mt-1 " htmlFor="mobile_number">
            <h3>Mobile Number</h3>
            <input
              name="mobile_number"
              type="text"
        ...
        <div className="m-2  form-element d-flex justify-content-center bg-light">
          <label className=" p-2 mt-1 " htmlFor="people">
            <h3>People</h3>
            <input
              name="people"
              type="number"
